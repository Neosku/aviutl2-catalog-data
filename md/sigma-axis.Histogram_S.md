...
「オブジェクトを追加」メニュー → 編集補助  →  色調整  → Histogram_S
...
※引用元：[Histogram_S/README.md](https://github.com/sigma-axis/aviutl2_script_Histogram_S/blob/main/README.md)

## 参考

- [説明文章](https://github.com/sigma-axis/aviutl2_script_Histogram_S/blob/main/README.md)
- [紹介動画](https://www.nicovideo.jp/watch/sm45695828)
